...
(function () {
    ...
    var I18N = {
        en: {
            ...
            just_now: 'Just now',
            q_restroom: 'Restrooms', q_food: 'Food', q_crowds: 'Crowds', q_parking: 'Parking', q_accessible: 'Accessible', q_eco: 'Eco', q_schedule: 'Schedule', q_medical: 'Medical', q_merch: 'Merchandise', q_lost: 'Lost & Found', q_service: 'Service',
            ...
            fan_experience: 'Fan Experience', command_center: 'Command Center',
            restrooms: 'Restrooms', food: 'Food', crowds: 'Crowds', parking: 'Parking',
            accessible: 'Accessible', eco: 'Eco', schedule: 'Schedule', medical: 'Medical',
            merchandise: 'Merchandise', lost_found: 'Lost & Found', service: 'Service',
            crowd_map: 'Crowd', map: 'Map', transport: 'Transport',
            hero_title: 'Your Personal AI Stadium Assistant',
        ...
        es: {
            ...
            just_now: 'Ahora',
            q_restroom: 'Ba\u00f1os', q_food: 'Comida', q_crowds: 'Multitudes', q_parking: 'Parking', q_accessible: 'Accesible', q_eco: 'Eco', q_schedule: 'Calendario', q_medical: 'M\u00e9dico', q_merch: 'Tienda', q_lost: 'Objetos Perdidos', q_service: 'Servicio',
            ...
            fan_experience: 'Experiencia Fan', command_center: 'Centro de Mando',
            restrooms: 'Ba\u00f1os', food: 'Comida', crowds: 'Multitudes', parking: 'Parking',
            accessible: 'Accesible', eco: 'Eco', schedule: 'Calendario', medical: 'M\u00e9dico',
            merchandise: 'Tienda', lost_found: 'Objetos Perdidos', service: 'Servicio',
            crowd_map: 'Multitud', map: 'Mapa', transport: 'Transporte',
            hero_title: 'Tu Personal Asistente de Estadio con IA',
            command_center_title: 'Centro de Mando de Operaciones',
        },
        fr: {
            ...
            just_now: 'Maintenant',
            q_restroom: 'Toilettes', q_food: 'Nourriture', q_crowds: 'Foules', q_parking: 'Parking', q_accessible: 'Accessible', q_eco: ' \u00c9co', q_schedule: 'Calendrier', q_medical: 'M\u00e9dical', q_merch: 'Boutique', q_lost: 'Objets Trouv\u00e9s', q_service: 'Service',
            ...
            fan_experience: 'Exp\u00e9rience Fan', command_center: 'Centre de Commande',
            restrooms: 'Toilettes', food: 'Nourriture', crowds: 'Foules', parking: 'Parking',
            accessible: 'Accessible', eco: ' \u00c9co', schedule: 'Calendrier', medical: 'M\u00e9dical',
            merchandise: 'Boutique', lost_found: 'Objets Trouv\u00e9s', service: 'Service',
            crowd_map: 'Foule', map: 'Carte', transport: 'Transport',
            hero_title: 'Votre Personnel Assistant de Stade IA',
            command_center_title: 'Centre de Commande Op\u00e9rationsnel',
        },
        de: {
            ...
            just_now: 'Jetzt',
            q_restroom: 'Toiletten', q_food: 'Essen', q_crowds: 'Mengen', q_parking: 'Parkplatz', q_accessible: 'Barrierefrei', q_eco: '\u00d6ko', q_schedule: 'Zeitplan', q_medical: 'Medizinisch', q_merch: 'Shop', q_lost: 'Fundsachen', q_service: 'Service',
            ...
            fan_experience: 'Fan-Erfahrung', command_center: 'Kommandozentrale',
            restrooms: 'Toiletten', food: 'Essen', crowds: 'Mengen', parking: 'Parkplatz',
            accessible: 'Barrierefrei', eco: '\u00d6ko', schedule: 'Zeitplan', medical: 'Medizinisch',
            merchandise: 'Shop', lost_found: 'Fundsachen', service: 'Service',
            crowd_map: 'Menge', map: 'Karte', transport: 'Transport',
            hero_title: 'Ihr Pers\u00f6nlicher KI-Stadion Assistent',
            command_center_title: 'Operations-Kommandozentrale',
        },
        zh: {
            loader_sub: 'AI\u7cfb\u7edf\u521d\u59cb\u5316\u4e2d',
            ...
            just_now: '\u521a\u521a',
            q_restroom: '\u6d17\u624b\u95f4', q_food: '\u98df\u7269', q_crowds: '\u4eba\u7fa4', q_parking: '\u505c\u8f66', q_accessible: '\u65e0\u969c\u788d', q_eco: '\u73af\u4fdd', q_schedule: '\u65e5\u7a0b', q_medical: '\u533b\u7597', q_merch: '\u5546\u5e97', q_lost: '\u5931\u7269\u62fe\u9057', q_service: '\u670d\u52a1',
            ...
            fan_experience: '\u7c89\u4e1d\u4f53\u9a8c', command_center: '\u6307\u6325\u4e2d\u5fc3',
            restrooms: '\u6d17\u624b\u95f4', food: '\u98df\u7269', crowds: '\u4eba\u7fa4', parking: '\u505c\u8f66',
            accessible: '\u65e0\u969c\u788d', eco: '\u73af\u4fdd', schedule: '\u65e5\u7a0b', medical: '\u533b\u7597',
            merchandise: '\u5546\u5e97', lost_found: '\u5931\u7269\u62fe\u9057', service: '\u670d\u52a1',
            crowd_map: '\u4eba\u7fa4', map: '\u5730\u56fe', transport: '\u4ea4\u901a',
            hero_title: '\u60a8\u7684\u4e2a\u4ebaAI\u667a\u80fd\u4f53\u80b2\u573a\u52a9\u624b',
            command_center_title: '\u8fd0\u8425\u6307\u6325\u4e2d\u5fc3',
        },
        ja: {
            ...
            just_now: '\u4eca\u3059\u3050',
            q_restroom: '\u30c8\u30a4\u30ec', q_food: '\u98df\u4e8b', q_crowds: '\u4eba\u6ce2', q_parking: '\u99d0\u8eeb\u5834', q_accessible: '\u30a2\u30af\u30bb\u30b7\u30d3\u30eb', q_eco: '\u30a8\u30b3', q_schedule: '\u65e5\u7a0b', q_medical: '\u533b\u7642', q_merch: '\u30b7\u30e7\u30c3\u30d7', q_lost: '\u907a\u5931\u7269', q_service: '\u30b5\u30fc\u30d3\u30b9',
            ...
            fan_experience: '\u30d5\u30a1\u30f3\u4f53\u9a13', command_center: '\u30b3\u30de\u30f3\u30c9\u30bb\u30f3\u30bf\u30fc',
            restrooms: '\u30c8\u30a4\u30ec', food: '\u98df\u4e8b', crowds: '\u4eba\u6ce2', parking: '\u99d0\u8eeb\u5834',
            accessible: '\u30a2\u30af\u30bb\u30b7\u30d3\u30eb', eco: '\u30a8\u30b3', schedule: '\u65e5\u7a0b', medical: '\u533b\u7642',
            merchandise: '\u30b7\u30e7\u30c3\u30d7', lost_found: '\u907a\u5931\u7269', service: '\u30b5\u30fc\u30d3\u30b9',
            crowd_map: '\u4eba\u6ce2', map: '\u5730\u56f3', transport: '\u4ea4\u901a',
            hero_title: '\u3042\u306a\u305f\u306e\u30da\u30fc\u30b7\u30e3\u30ebAI\u30b9\u30bf\u30b8\u30a2\u30e2\u30a2\u30b7\u30b9\u30bf\u30f3\u30c8',
            command_center_title: '\u904b\u55b6\u30b3\u30de\u30f3\u30c9\u30bb\u30f3\u30bf\u30fc',
        },
        ko: {
            ...
            just_now: '방금',
            q_restroom: '화장실', q_food: '음식', q_crowds: '혼잡도', q_parking: '주차', q_accessible: '접근성', q_eco: '에코', q_schedule: '일정', q_medical: '의료', q_merch: '상점', q_lost: '유실물', q_service: '서비스',
            ...
            fan_experience: '팬 경험', command_center: '지휘 센터',
            restrooms: '화장실', food: '음식', crowds: '혼잡도', parking: '주차',
            accessible: '접근성', eco: '에코', schedule: '일정', medical: '의료',
            merchandise: '상점', lost_found: '유실물', service: '서비스',
            crowd_map: '혼잡도', map: '지도', transport: '교통',
            hero_title: '나만의 AI 경기장 어시스턴트',
            command_center_title: '운영 지휘 센터',
        },
        pt: {
            loader_sub: 'Inicializando sistemas de IA',
            ...
            just_now: 'Agora',
            q_restroom: 'Banheiros', q_food: 'Comida', q_crowds: 'Multid\u00e3o', q_parking: 'Estacionamento', q_accessible: 'Acess\u00edvel', q_eco: 'Eco', q_schedule: 'Calend\u00e1rio', q_medical: 'M\u00e9dico', q_merch: 'Loja', q_lost: 'Achados e Perdidos', q_service: 'Servi\u00e7o',
            ...
            fan_experience: 'Experi\u00eancia do F\u00e3', command_center: 'Centro de Comando',
            restrooms: 'Banheiros', food: 'Comida', crowds: 'Multid\u00e3o', parking: 'Estacionamento',
            accessible: 'Acess\u00edvel', eco: 'Eco', schedule: 'Calend\u00e1rio', medical: 'M\u00e9dico',
            merchandise: 'Loja', lost_found: 'Achados e Perdidos', service: 'Servi\u00e7o',
            crowd_map: 'Multid\u00e3o', map: 'Mapa', transport: 'Transporte',
            hero_title: 'Seu Pessoal Assistente de Est\u00e1dio IA',
            command_center_title: 'Centro de Comando de Opera\u00e7\u00f5es',
        },
        hi: {
            ...
            just_now: '\u0905\u092d\u0940',
            q_restroom: '\u0936\u094c\u091a\u093e\u0918\u0930', q_food: '\u0916\u093e\u0928\u093e', q_crowds: '\u092d\u0940\u0921\u093c', q_parking: '\u092a\u093e\u0930\u094d\u0915\u093f\u0902\u0917', q_accessible: '\u0938\u0941\u0932\u092d', q_eco: '\u091f\u093f\u0915\u093e\u094b', q_schedule: '\u0936\u0947\u0921\u0942\u0932', q_medical: '\u092e\u0947\u0921\u093f\u0915\u0932', q_merch: '\u0938\u094d\u091f\u094b\u0930', q_lost: '\u0916\u094b\u092f\u0924\u093e \u092a\u093e\u092f\u093e', q_service: '\u0938\u0947\u0935\u093e',
            ...
            fan_experience: '\u092a\u094d\u0930\u0936\u0902\u0938\u0915 \u0905\u0928\u0941\u092d\u0935', command_center: '\u0915\u092e\u093e\u0902\u0921 \u0938\u0947\u0902\u091f\u0930',
            restrooms: '\u0936\u094c\u091a\u093e\u0918\u0930', food: '\u0916\u093e\u0928\u093e', crowds: '\u092d\u0940\u0921\u093c', parking: '\u092a\u093e\u0930\u094d\u0915\u093f\u0902\u0917',
            accessible: '\u0938\u0941\u0932\u092d', eco: '\u091f\u093f\u0915\u093e\u094b', schedule: '\u0936\u0947\u0921\u0942\u0932', medical: '\u092e\u0947\u0921\u093f\u0915\u0932',
            merchandise: '\u0938\u094d\u091f\u094b\u0930', lost_found: '\u0916\u094b\u092f\u0924\u093e \u092a\u093e\u092f\u093e', service: '\u0938\u0947\u0935\u093e',
            crowd_map: '\u092d\u0940\u0921\u093c', map: '\u0928\u0915\u094d\u0936\u093e', transport: '\u092a\u0930\u093f\u0935\u0939\u093e\u0928',
            hero_title: '\u0906\u092a\u0915\u093e \u0935\u094d\u092f\u0915\u094d\u0924\u093f\u0917\u0935 AI \u0938\u094d\u091f\u0947\u0921\u093f\u092f\u092e \u0938\u0939\u093e\u092f\u0915',
            command_center_title: '\u0913\u092a\u0930\u0947\u0936\u0902\u0938 \u0915\u092e\u093e\u0902\u0921 \u0938\u0947\u0902\u091f\u0930',
        },
        ar: {
            loader_sub: '\u062a\u0647\u064a\u0626\u0629 \u0627\u0644\u0623\u0646\u0638\u0645\u0629 \u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064a',
            nav_fan: '\u062a\u062c\u0631\u0628\u0629 \u0627\u0644\u0645\u0634\u062c\u0639\u064a\u0646', nav_cmd: '\u0645\u0631\u0643\u0632 \u0627\u0644\u0642\u064a\u0627\u062f\u0629',
            systems_online: '\u0627\u0644\u0623\u0646\u0638\u0645\u0629 \u0645\u062a\u0635\u0644\u0629',
            hero_badge: '\u0643\u0623\u0633 \u0627\u0644\u0639\u0627\u0644\u0645 FIFA 2026',
            hero_title_1: '\u0645\u0633\u0627\u0639\u062f\u0643 \u0627\u0644\u0634\u062e\u0635\u064a', hero_title_2: '\u0645\u0633\u0627\u0639\u062f \u0630\u0643\u0627\u0621', hero_title_3: '\u0627\u0644\u0625\u0631\u0634\u0627\u062f \u0627\u0644\u0645\u062f\u0631\u0628',
            hero_sub: '\u062a\u0646\u0642\u0651\u0644 \u0628\u0630\u0643\u0627\u0621\u060c \u0627\u0633\u062a\u0645\u062a\u0639 \u0623\u0643\u062b\u0631\u060c \u0645\u062f\u0639\u0648\u0645 \u0628\u062a\u0642\u0646\u064a\u0629 Google Gemini 2.5 Flash.',
            stat_capacity: '\u0627\u0644\u0633\u0639\u0629', stat_endpoints: '\u0646\u0642\u0627\u0637 API', stat_languages: '\u0627\u0644\u0644\u063a\u0627\u062a', stat_tests: '\u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631\u0627\u062a',
            ai_assistant: '\u0645\u0633\u0627\u0639\u062f \u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064a', ai_sub: '\u0645\u062f\u0639\u0648\u0645 \u0628\u062a\u0642\u0646\u064a\u0629 Gemini 2.5 Flash', active: '\u0646\u0634\u0637',
            greeting_title: '\u0645\u0631\u062d\u0628\u064b\u0627 \u0628\u0643 \u0641\u064a StadiumIQ!',
            greeting_sub: '\u0623\u0646\u0627 \u0645\u0633\u0627\u0639\u062f\u0643 \u0627\u0644\u0645\u062f\u0639\u0648\u0645 \u0628\u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064a \u0644\u0643\u0623\u0633 \u0627\u0644\u0639\u0627\u0644\u0645 <strong>FIFA 2026</strong> \u0641\u064a \u0645\u0644\u0639\u0628 MetLife.',
            feat_nav: '\u0627\u0644\u062a\u0646\u0642\u0644', feat_crowds: '\u0627\u0644\u062d\u0634\u0648\u062f', feat_a11y: '\u0625\u0645\u0643\u0627\u0646\u064a\u0629 \u0627\u0644\u0648\u0635\u0648\u0644', feat_eco: '\u0627\u0644\u0627\u0633\u062a\u062f\u0627\u0645\u0629', feat_match: '\u0645\u0639\u0644\u0648\u0645\u0627\u062a \u0627\u0644\u0645\u0628\u0627\u0631\u0627\u0629', feat_transport: '\u0627\u0644\u0645\u0648\u0627\u0635\u0644\u0627\u062a',
            just_now: '\u0627\u0644\u0622\u0646',
            q_restroom: '\u062f\u0648\u0631\u0627\u062a \u0627\u0644\u0645\u064a\u0627\u0647', q_food: '\u0627\u0644\u0637\u0639\u0627\u0645', q_crowds: '\u0627\u0644\u062d\u0634\u0648\u062f', q_parking: '\u0627\u0644\u0645\u0648\u0627\u0642\u0651\u0641', q_accessible: '\u0625\u0645\u0643\u0627\u0646\u064a\u0629 \u0627\u0644\u0648\u0635\u0648\u0644', q_eco: '\u0627\u0644\u0628\u064a\u0626\u0629', q_schedule: '\u0627\u0644\u062c\u062f\u0648\u0644', q_medical: '\u0637\u0628\u064a', q_merch: '\u0627\u0644\u0645\u062a\u062c\u0631', q_lost: '\u0627\u0644\u0645\u0641\u0642\u0648\u062f\u0627\u062a', q_service: '\u0627\u0644\u062e\u062f\u0645\u0629',
            chat_placeholder: '\u0627\u0633\u0623\u0644\u0646\u064a \u0623\u064a \u0634\u064a\u0621 \u0639\u0646 \u0627\u0644\u0645\u0644\u0639\u0628...',
            tab_crowd: '\u0627\u0644\u062d\u0634\u0648\u062f', tab_map: '\u0627\u0644\u062e\u0631\u064a\u0637\u0629', tab_transport: '\u0627\u0644\u0645\u0648\u0627\u0635\u0644\u0627\u062a', tab_eco: '\u0627\u0644\u0628\u064a\u0626\u0629',
            crowd_title: '\u0643\u062b\u0627\u0641\u0629 \u0627\u0644\u062d\u0634\u0648\u062f \u0641\u064a \u0627\u0644\u0648\u0642\u062a \u0627\u0644\u0641\u0639\u064a\u0644\u064a', live: '\u0645\u0628\u0627\u0634\u0631',
            map_title: '\u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0645\u0631\u0627\u0641\u0642 \u0627\u0644\u062a\u0641\u0627\u0639\u0644\u064a\u0629', transport_title: '\u0645\u0631\u0643\u0632 \u0627\u0644\u0646\u0642\u0644', eco_title: '\u0644\u0648\u062d\u0629 \u0627\u0644\u0627\u0633\u062a\u062f\u0627\u0645\u0629',
            cmd_title: '\u0645\u0631\u0643\u0632 \u0642\u064a\u0627\u062f\u0629 \u0627\u0644\u0639\u0645\u0644\u064a\u0627\u062a', cmd_sub: '\u0645\u0639\u0644\u0648\u0645\u0627\u062a \u0627\u0644\u0645\u0644\u0639\u0628 \u0641\u064a \u0627\u0644\u0648\u0642\u062a \u0627\u0644\u0641\u0639\u064a\u0644\u064a \u0648\u062a\u062d\u0644\u064a\u0644\u0627\u062a \u062a\u0634\u063a\u064a\u0644\u064a\u0629',
            cmd_crowd: '\u062a\u062f\u0641\u0642 \u0627\u0644\u062d\u0634\u0648\u062f', cmd_sentiment: '\u0634\u0639\u0648\u0631 \u0627\u0644\u0645\u0634\u062c\u0639\u064a\u0646', cmd_risk: '\u062a\u0642\u064a\u064a\u0645 \u0627\u0644\u0645\u062e\u0627\u0637\u0631',
            cmd_alerts: '\u062a\u0646\u0628\u064a\u0647\u0627\u062a \u0645\u0628\u0627\u0634\u0631\u0629', cmd_staff: '\u0646\u0634\u0631 \u0627\u0644\u0645\u0648\u0638\u0641\u064a\u0646', cmd_insights: '\u062a\u062d\u0644\u064a\u0644\u0627\u062a \u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064a',
            footer_left: 'StadiumIQ v3.0 \u2014 \u0645\u062f\u0639\u0648\u0645 \u0628\u062a\u0642\u0646\u064a\u0629 Google Gemini 2.5 Flash',
            footer_right: '\u0643\u0623\u0633 \u0627\u0644\u0639\u0627\u0644\u0645 FIFA 2026 \u2014 \u0645\u0644\u0639\u0628 MetLife',
            toast_ready: '\u0645\u0639\u062f StadiumIQ \u062c\u0627\u0647\u0632\u0601 \u0627\u0633\u0623\u0644\u0646\u064a \u0623\u064a \u0634\u064a\u0621.',
            toast_lang: '\u062a\u0645 \u062a\u063a\u064a\u064a\u0631 \u0627\u0644\u0644\u063a\u0629 \u0625\u0644\u0649',
            fac_gate1: '\u0627\u0644\u0628\u0648\u0627\u0628\u0629 E1 \u2014 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629 \u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0629', fac_gate2: '\u0627\u0644\u0628\u0648\u0627\u0628\u0629 E2 \u2014 \u0627\u0644\u0634\u0631\u0642\u064a\u0629', fac_gate3: '\u0627\u0644\u0628\u0648\u0627\u0628\u0629 E3 \u2014 \u0627\u0644\u062c\u0646\u0648\u0628\u064a\u0629', fac_gate4: '\u0627\u0644\u0628\u0648\u0627\u0628\u0629 E4 \u2014 \u0643\u0628\u0627\u0631 \u0627\u0644\u0634\u062e\u0635',
            fac_rest_n: '\u062f\u0648\u0631\u0629 \u0645\u064a\u0627\u0647 \u0627\u0644\u0634\u0645\u0627\u0644', fac_rest_e: '\u062f\u0648\u0631\u0629 \u0645\u064a\u0627\u0647 \u0627\u0644\u0634\u0631\u0642\u064a\u0629',
            fac_food_n: '\u0633\u0627\u062d\u0629 \u0627\u0644\u0637\u0639\u0627\u0645 \u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0629', fac_food_e: '\u0633\u0627\u062d\u0629 \u0627\u0644\u0637\u0639\u0627\u0645 \u0627\u0644\u0634\u0631\u0642\u064a\u0629', fac_food_s: '\u0633\u0627\u062d\u0629 \u0627\u0644\u0637\u0639\u0627\u0645 \u0627\u0644\u062c\u0646\u0648\u0628\u064a\u0629', fac_food_w: '\u0633\u0627\u062d\u0629 \u0627\u0644\u0637\u0639\u0627\u0645 \u0627\u0644\u063a\u0631\u0628\u064a\u0629',
            fac_food_n_sub: '\u0623\u0645\u0631\u064a\u0643\u064a\u060c \u0645\u0643\u0633\u064a\u0643\u064a', fac_food_e_sub: '\u0622\u0633\u064a\u0648\u064a\u060c \u0625\u0637\u0627\u0644\u064a\u0627\u0646\u064a', fac_food_s_sub: '\u062d\u0644\u0627\u0644\u060c \u0646\u0628\u0627\u062a\u064a', fac_food_w_sub: '\u0628\u0631\u062c\u0631\u060c \u0628\u064a\u062a\u0632\u0627',
            fac_med_n: '\u0627\u0644\u0645\u0631\u0643\u0632 \u0627\u0644\u0637\u0628\u064a \u0627\u0644\u0634\u0645\u0627\u0644\u064a', fac_med_s: '\u0627\u0644\u0645\u0631\u0643\u0632 \u0627\u0644\u0637\u0628\u064a \u0627\u0644\u062c\u0646\u0648\u0628\u064a',
            fac_eco_n: '\u0645\u062d\u0637\u0629 \u0627\u0644\u0628\u064a\u0626\u0629 \u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0629', fac_eco_s: '\u0645\u062d\u0637\u0629 \u0627\u0644\u0628\u064a\u0626\u0629 \u0627\u0644\u062c\u0646\u0648\u0628\u064a\u0629', fac_accessible: '\u0625\u0645\u0643\u0627\u0646\u064a\u0629 \u0627\u0644\u0648\u0635\u0648\u0644',
            tr_parking: '\u0627\u0644\u0645\u0648\u0627\u0642\u0651\u0641', tr_lot_a: '\u0627\u0644\u0645\u0648\u0642\u0641 A (\u0634\u0645\u0627\u0644\u064a)', tr_lot_b: '\u0627\u0644\u0645\u0648\u0642\u0641 B (\u0634\u0631\u0642\u064a)', tr_lot_c: '\u0627\u0644\u0645\u0648\u0642\u0641 C (\u062c\u0646\u0648\u0628\u064a)',
            tr_ev: '\u0634\u062d\u0646 \u0643\u0647\u0631\u0628\u0627\u0626\u064a', tr_no_ev: '\u0628\u062f\u0648\u0646 \u0634\u062d\u0646', tr_transit: '\u0627\u0644\u0646\u0642\u0644 \u0627\u0644\u0639\u0627\u0645', tr_metlife: '\u0645\u062d\u0637\u0629 MetLife', tr_bus: '\u0645\u062d\u0637\u0629 \u0627\u0644\u062d\u0627\u0641\u0644\u0627\u062a',
            tr_every: '\u0643\u0644', tr_min: '\u062f\u0642\u064a\u0642\u0629', tr_rideshare: '\u0645\u0634\u0627\u0631\u0643\u0629 \u0627\u0644\u0631\u062d\u0644\u0629', tr_pickup: '\u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0627\u0644\u062a\u0642\u0627\u0637', tr_dropoff: '\u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u062a\u062e\u0641\u064a\u0636',
            tr_west: '\u0627\u0644\u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u063a\u0631\u0628\u064a\u0629', tr_north: '\u0627\u0644\u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0629',
            eco_station_n: '\u0645\u062d\u0637\u0629 \u0627\u0644\u0628\u064a\u0626\u0629 \u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0629', eco_station_e: '\u0645\u062d\u0637\u0629 \u0627\u0644\u0628\u064a\u0626\u0629 \u0627\u0644\u0634\u0631\u0642\u064a\u0629', eco_station_s: '\u0645\u062d\u0637\u0629 \u0627\u0644\u0628\u064a\u0626\u0629 \u0627\u0644\u062c\u0646\u0648\u0628\u064a\u0629',
            eco_materials_1: '\u0628\u0644\u0627\u0633\u0637\u064a\u0643\u060c \u0648\u0631\u0642\u060c \u0632\u062c\u0627\u062c', eco_materials_2: '\u0628\u0644\u0627\u0633\u0637\u064a\u0643\u060c \u0648\u0631\u0642', eco_materials_3: '\u0627\u0644\u0643\u0644 + \u0646\u0641\u0627\u064a\u0627\u062a \u0627\u0644\u0637\u0639\u0627\u0645',
            eco_tips: '\u0646\u0635\u0627\u0626\u062d \u0628\u064a\u0626\u064a\u0629', eco_bike: '\u0627\u0631\u0643\u0628 \u0627\u0644\u062f\u0631\u0627\u062c\u0629 \u0625\u0644\u0649 \u0627\u0644\u0645\u0644\u0639\u0628', eco_transit: '\u0627\u0644\u0646\u0642\u0644 \u0627\u0644\u0639\u0627\u0645', eco_reusable: '\u0648\u0639\u0627\u0621 \u0642\u0627\u0628\u0644 \u0644\u0625\u0639\u0627\u062f\u0629 \u0627\u0633\u062a\u062e\u062f\u0627\u0645', eco_pts: '\u0646\u0642\u0627\u0637',
            alert_1: '\u0627\u0644\u0645\u0646\u0637\u0642\u0629 C \u062a\u0642\u062a\u0631\u0628 \u0645\u0646 80% \u0645\u0646 \u0627\u0644\u0633\u0639\u0629', alert_1_time: '\u0645\u0646\u0630 2 \u062f\u0642\u064a\u0642\u0629',
            alert_2: '\u062a\u0645\u062a \u0625\u062f\u0627\u0631\u0629 \u0632\u062d\u0645\u0629 \u0627\u0644\u0627\u0633\u062a\u0631\u0627\u062d\u0629 \u0628\u0646\u062c\u0627\u062d', alert_2_time: '\u0645\u0646\u0630 5 \u062f\u0642\u0627\u0626\u0642',
            alert_3: '\u0645\u062d\u0637\u0629 \u0628\u064a\u0626\u0629 \u062c\u062f\u064a\u062f\u0629 \u0641\u064a \u0627\u0644\u0645\u0646\u0637\u0642\u0629 D', alert_3_time: '\u0645\u0646\u0630 8 \u062f\u0642\u0627\u0626\u0642',
            alert_4: '\u062a\u0645 \u0627\u0643\u062a\u0634\u0627\u0641 \u0645\u0633\u062a\u0648\u064a\u0627\u062a \u0636\u0648\u0636\u0627\u0621 \u0639\u0627\u0644\u064a\u0629 \u0641\u064a \u0627\u0644\u0645\u0646\u0637\u0642\u0629 A', alert_4_time: '\u0645\u0646\u0630 12 \u062f\u0642\u064a\u0642\u0629',
            alert_5: '\u0648\u0642\u062a \u0627\u0644\u0627\u0633\u062a\u062c\u0627\u0628\u0629 \u0627\u0644\u0637\u0628\u064a\u0629: 2.1 \u062f\u0642\u064a\u0642\u0629', alert_5_time: '\u0645\u0646\u0630 15 \u062f\u0642\u064a\u0642\u0629',
            staff_cleaning: '\u0627\u0644\u062a\u0646\u0638\u064a\u0641', staff_crowd: '\u0625\u062f\u0627\u0631\u0629 \u0627\u0644\u062d\u0634\u0648\u062f', staff_guest: '\u062e\u062f\u0645\u0627\u062a \u0627\u0644\u0636\u064a\u0648\u0641', staff_medical: '\u0637\u0628\u064a', staff_security: '\u0627\u0644\u0623\u0645\u0646',
            ai_recommendation: '\u062a\u0648\u0635\u064a\u0629 \u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064a',
            zone_a: '\u0627\u0644\u0645\u0646\u0635\u0629 \u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0629', zone_b: '\u0627\u0644\u0645\u0646\u0635\u0629 \u0627\u0644\u0634\u0631\u0642\u064a\u0629', zone_c: '\u0627\u0644\u0645\u0646\u0635\u0629 \u0627\u0644\u062c\u0646\u0648\u0628\u064a\u0629', zone_d: '\u0627\u0644\u0645\u0646\u0635\u0629 \u0627\u0644\u063a\u0631\u0628\u064a\u0629',
            level_low: '\u0645\u0646\u062e\u0641\u0636', level_moderate: '\u0645\u062a\u0648\u0633\u0637', level_high: '\u0645\u0631\u062a\u0641\u0639', level_critical: '\u062d\u0631\u062c', level_overflow: '\u0641\u0627\u0626\u0636',
            svg_a: '\u0627\u0644\u0645\u0646\u0637\u0642\u0629 A \u2014 \u0627\u0644\u0634\u0645\u0627\u0644\u064a\u0629', svg_b: '\u0627\u0644\u0645\u0646\u0637\u0642\u0629 B \u2014 \u0627\u0644\u0634\u0631\u0642\u064a\u0629', svg_c: '\u0627\u0644\u0645\u0646\u0637\u0642\u0629 C \u2014 \u0627\u0644\u062c\u0646\u0648\u0628\u064a\u0629', svg_d: '\u0627\u0644\u0645\u0646\u0637\u0642\u0629 D \u2014 \u0627\u0644\u063a\u0631\u0628\u064a\u0629',
            fan_experience: '\u062a\u062c\u0631\u0628\u0629 \u0627\u0644\u0645\u0634\u062c\u0639\u064a\u0646', command_center: '\u0645\u0631\u0643\u0632 \u0627\u0644\u0642\u064a\u0627\u062f\u0629',
            restrooms: '\u062f\u0648\u0631\u0627\u062a \u0627\u0644\u0645\u064a\u0627\u0647', food: '\u0627\u0644\u0637\u0639\u0627\u0645', crowds: '\u0627\u0644\u062d\u0634\u0648\u062f', parking: '\u0627\u0644\u0645\u0648\u0627\u0642\u0651\u0641',
            accessible: '\u0625\u0645\u0643\u0627\u0646\u064a\u0629 \u0627\u0644\u0648\u0635\u0648\u0644', eco: '\u0627\u0644\u0628\u064a\u0626\u0629', schedule: '\u0627\u0644\u062c\u062f\u0648\u0644', medical: '\u0637\u0628\u064a',
            merchandise: '\u0627\u0644\u0645\u062a\u062c\u0631', lost_found: '\u0627\u0644\u0645\u0641\u0642\u0648\u062f\u0627\u062a', service: '\u0627\u0644\u062e\u062f\u0645\u0629',
            crowd_map: '\u0627\u0644\u062d\u0634\u0648\u062f', map: '\u0627\u0644\u062e\u0631\u064a\u0637\u0629', transport: '\u0627\u0644\u0645\u0648\u0627\u0635\u0644\u0627\u062a',
            hero_title: '\u0645\u0633\u0627\u0639\u062f\u0643 \u0627\u0644\u0634\u062e\u0635\u064a \u0627\u0644\u0625\u0631\u0634\u0627\u062f \u0627\u0644\u0645\u062f\u0631\u0628 \u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064a',
            command_center_title: '\u0645\u0631\u0643\u0632 \u0642\u064a\u0627\u062f\u0629 \u0627\u0644\u0639\u0645\u0644\u064a\u0627\u062a',
        },
    };
